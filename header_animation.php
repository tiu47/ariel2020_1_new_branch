				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<div class=" ms-auto text-end col-12  col-md-4">
						<ul class="navbar-nav py-5 pb-0  py-md-0">
							<li class="nav-item text-center"><a class=" anchor p-2 px-3 rounded-1 active header_ArielBarrios" href="#ArielBarrios"  >Hi!</a> </li>
							<li class="nav-item  text-center"><a class="anchor p-2 px-3 rounded-1 header_Works" href="#Works"  >Works</a> </li>
							<li class="nav-item  text-center"><a class="anchor p-2 px-3 rounded-1 header_Contact" href="#Contact"  >Contact</a></li>
						</ul>
						</ul>
					</div>
				</div>
